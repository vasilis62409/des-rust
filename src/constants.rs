...
pub const IP: [u32; 64] = [58, 50, 42, 34, 26, 18, 10, 2,
...
pub const KEY_SHIFT: [u8; 56] = [57, 49,  41,  33,  25,  17,   9,
                              1, 58,  50,  42,  34,  26,  18,
                             10,  2,  59,  51,  43,  35,  27,
                             19, 11,   3,  60,  52,  44,  36,
...
pub const COMPRESSION: [u32; 48] =[14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10,
                               23, 19, 12, 4, 26, 8, 16, 7, 27, 20, 13, 2,
                               41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48,
                               44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29, 32];

pub const EXPANSION: [u32; 48] = [31,  0,  1,  2,  3,  4, 
                               3,  4,  5,  6,  7,  8,
                               7,  8,  9, 10, 11, 12,
                              11, 12, 13, 14, 15, 16,
                              15, 16, 17, 18, 19, 20,
...
pub static P_BOX:[u32; 32] = [16,  7, 20, 21,
                          29, 12, 28, 17,
                           1, 15, 23, 26,
                           5, 18, 31, 10,
                           2,  8, 24, 14,
